...
eval("module.exports = {\n    ACCUWEATHER_API_KEY: 'cUdYmQBrT5ceVvOz4yJedEcemWGJAgfY'\n}\n\n//# sourceURL=webpack://agent-sandbox/./.config?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   getCurrentLocation: () => (/* binding */ getCurrentLocation),\n/* harmony export */   getCurrentWeather: () => (/* binding */ getCurrentWeather),\n/* harmony export */   getCurrentWeather_backup: () => (/* binding */ getCurrentWeather_backup)\n/* harmony export */ });\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../.config */ \"./.config\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_config__WEBPACK_IMPORTED_MODULE_0__);\n\n\nconsole.log(_config__WEBPACK_IMPORTED_MODULE_0__.ACCUWEATHER_API_KEY)\n\nasync function getCurrentLocation(){\n    return 'Boston, MA'\n}\n\nasync function getCurrentWeather_backup(){\n    const weather = {\n        temperature: '21',\n        unit: 'C',\n        forecast: 'sunny'\n    }\n    return JSON.stringify(weather)\n}\n\nasync function getCurrentWeather(){\n    // GET location key from AccuWeather API\n    const location = await getCurrentLocation()\n    const location_key = await fetch(`http://dataservice.accuweather.com/locations/v1/cities/search?apikey=${_config__WEBPACK_IMPORTED_MODULE_0__.ACCUWEATHER_API_KEY}&q=${location}`)\n    const location_key_json = await location_key.json()\n    const location_key_id = location_key_json[0].Key\n\n    // GET current conditions from AccuWeather API\n    const current_conditions = await fetch(`http://dataservice.accuweather.com/currentconditions/v1/${location_key_id}?apikey=${_config__WEBPACK_IMPORTED_MODULE_0__.ACCUWEATHER_API_KEY}`)\n    const current_conditions_json = await current_conditions.json()\n\n    const weather = {\n        temperature: current_conditions_json[0].Temperature.Metric.Value,\n        unit: current_conditions_json[0].Temperature.Metric.Unit,\n        forecast: current_conditions_json[0].WeatherText\n    }\n    \n    console.log(JSON.stringify(weather))\n    return JSON.stringify(weather)\n\n}\n\n//# sourceURL=webpack://agent-sandbox/./src/tools.js?");
